  ...
  public class Settings
  {
    ...
    public Dictionary<string, string> Regions
    {
      get
      {
        ...
        list.Add("Japan", "JP");
        list.Add("Jordan", "JO");
        list.Add("Malaysia", "MY");
        list.Add("Mexico", "MX");
        list.Add("Morocco", "MA");
        list.Add("Netherlands", "NL");
        list.Add("New Zealand", "NZ");
        list.Add("Peru", "PE");
        list.Add("Philippines", "PH");
        list.Add("Poland", "PL");
        list.Add("Russia", "RU");
        list.Add("Saudi Arabia", "SA");
        list.Add("Singapore", "SG");
        list.Add("South Africa", "ZA");
        list.Add("South Korea", "KR");
        list.Add("Spain", "ES");
        list.Add("Sweden", "SE");
        list.Add("Taiwan", "TW");
        list.Add("United Arab Emirates", "AE");
